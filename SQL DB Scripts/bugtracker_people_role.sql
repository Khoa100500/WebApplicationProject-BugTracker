...
LOCK TABLES `people_role` WRITE;
/*!40000 ALTER TABLE `people_role` DISABLE KEYS */;
INSERT INTO `people_role` VALUES (1,'admin'),(2,'staff'),(3,'user');
/*!40000 ALTER TABLE `people_role` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-15 21:37:41
